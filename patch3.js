...
const oldImages = `        <div className="design-img-container absolute top-[14%] left-0 w-[320vw] h-[60%] pointer-events-none z-10 flex items-center will-change-transform">
...
const newImages = `        <div className="design-img-container absolute top-[14%] left-0 w-[250vw] h-[60%] pointer-events-none z-10 flex items-center will-change-transform">
